 ...
 * @param {string} jurisdiction - Jurisdiction string (e.g., "US", "UK", "CA")
 * @param {boolean} returnHex - If true, return hex string instead of decimal string
 * @returns {string} - Hash as a string number or hex string (for contract compatibility)
 */
 ...
 * @param {string[]} jurisdictions - Array of jurisdiction strings
 * @returns {string[]} - Array of hash numbers as strings
 */
 ...
 * @param {string} input - Comma-separated jurisdiction strings or numbers
 * @returns {string[]} - Array of hash numbers as strings
 */
